...
8. Restrição do tratamento

### Deveres dos Controladores
1. Garantir transparência
2. Garantir segurança
3. Manter RIPD atualizado
4. Comunicar incidentes
5. Realizar DPIA quando necessário

## Fontes Oficiais
- **Site:** https://www.anpd.gov.br
- **Documentos:** https://www.anpd.gov.br/ documentacao
- **Portal:** https://acceso.anpd.gov.br

## Casos Relevantes
- **Caso Claro/Serasa** - Tratamento de dados em ambiente judiciário
